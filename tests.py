...
class TestParseHeader(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        print(json.dumps(decode_dict(self.obj.headers), sort_keys=True, indent=4))
    ...
    def test_response_excludes_remove_append_save(self):
        ...
        self.assertEqual(self.obj.getheaders(), [(b'content-type', b'text/plain')])
        self.obj.remove(b'content-type')
        self.assertEqual(self.obj.getheaders(), [])
        self.obj.append((b'Content-Type', b'text/html'))
        self.assertEqual(self.obj.getheaders(), [(b'Content-Type', b'text/html')])
